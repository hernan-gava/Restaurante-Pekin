          ...
          <div class="carousel-item active">
            ...
            <div class="container">
              <div class="carousel-caption text-left">
                <p align="center"><a class="btn btn-lg btn-warning" href="consulta-recibo-cfe" role="button">Registrate Gratis</a></p>
              </div>
            </div>
          </div>
...
================================================== -->
      <div class="card" ng-repeat="course in productos">                
        ...
        <br>
        <center>            
          <button style="width: 118px; height: 45px;" class="btn btn-warning" data-ng-click="mandoInfoProducto(course.idMenu, course.foto, course.nombre, course.descripcion, course.precio)" >Agregar</button>
        </center>           
      </div>
      ...
      <div id="footer" style="padding-top: 100px; margin-right: 175px;">
        ...
        <p>Creado por el Ing. Hernán García Valladares <a href="https://hernan-gava.github.io/Service/">
            <button style="width: 136px; height: 35px;" class="btn btn-warning">Acerca de</button>
          </a></p>
