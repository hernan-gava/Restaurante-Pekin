			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				...
				<div id="encabezadoCliente">
					<div
						...
						<h1 class="h2">Clientes Con Servicio CFE</h1>
				...
				<div id="formClienteGuardar">
						...
						<form id="clienteForm">
							...
							<div class="form-group">
								<label class="col-form-label">Nombre Completo del
									Cliente: </label> <input id="txtClienteName" type="text"
					...
					<div class="form-group">
						<label class="col-form-label">Seleccione la Pregunta: </label> <select
							...
							<option value="">PUEDE CONSULTAR EL USUARIO SU RECIBO
								CFE ?</option>
								...
								<form id="clienteForm2">
									<div class="form-group">
										<label for="recipient-name" class="col-form-label">ID
											Cliente: </label> <input id="txtidc" type="text" class="form-control"
											placeholder="Id" data-ng-model="producto.id_cliente"
											required="required"
											pattern="^[A-Z\u00C0-\u00DCa-z\u00E0-\u00FC0-9\s]{1,99}$"
											disabled="disabled">
									...
									<div class="form-group">
										<label class="col-form-label">Nombre del Cliente: </label> <input
									...
									<div class="form-group">
										<label class="col-form-label">Seleccione: </label> <select
											...
											<option value="">PUEDE CONSULTAR EL USUARIO SU
												RECIBO CFE ?</option>
											<option value="true">Si</option>
											<option value="false">No</option>
										</select>
