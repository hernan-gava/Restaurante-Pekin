...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	// Configuracion de rutas y extensiones que permite Spring Security a todos los
	// user Browser
	@Override
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable()
				...
				.antMatchers("/insertarClienteRole").permitAll()
				.antMatchers("/listarClienteRole").permitAll()
				.antMatchers("/actualizarClienteRole").permitAll()
				...
				.antMatchers("/redirect").hasAuthority("ROLE_ADMIN")
				
				//.antMatchers("/public-menu").hasAuthority("ROLE_ADMIN")
