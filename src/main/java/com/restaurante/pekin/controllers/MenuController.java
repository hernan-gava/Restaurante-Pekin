...
public class MenuController {
   ...
   public @ResponseBody
   Boolean insertarMenu(@RequestBody MenuDto menuDto) throws MenuException {
   ...
   public @ResponseBody
   Boolean updateMenu(@RequestBody MenuDto menuDto) throws MenuException {
      StringBuilder mensaje = new StringBuilder();      
      try {
   ...
   public @ResponseBody
   List<Menu> listarMenu() throws MenuException {
      return menuService.getAllMenu();
   }
   
   @DeleteMapping(value = DELETE_MENU)
   public @ResponseBody
   Boolean deleteMenu(@RequestBody MenuDto menuDto) throws MenuException {
      StringBuilder mensaje = new StringBuilder();
      try {
